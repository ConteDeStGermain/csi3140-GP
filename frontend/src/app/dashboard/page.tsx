...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen" style={{overflowX: "hidden"}}>
      ...
      <div className="mt-5 mb-2 p-4 bag-grey-200 rounded w-100 text-center">
          ...
          <button onClick={handleAZsort} className="bg-black w-fit hover:bg-gray-800 text-white py-2 px-4 rounded ">Sort: A-Z</button>
        </div>
