...
let stage = new Iroh.Stage(`
    ...
    fetch('http://localhost:8080/getNumberOfMessages');

    const numberOfMessages = 11;
    const numberOfTopics = Math.round((numberOfMessages/4) + 1);
    fetch('http://localhost:8080/getMessagesWithTopicModelling?number='+numberOfTopics.toString());
